...
const BankTabItem = (props: BankTabItemProps) => {
    const { account, appwriteItemId } = props;
    const accountAppwriteItemId = account?.appwriteItemId || '';
    const searchParams = useSearchParams();
    const router = useRouter();
    const isActive = appwriteItemId === accountAppwriteItemId;
